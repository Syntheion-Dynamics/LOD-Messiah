/**
 * LEGACY — LOD3 visual-hull / height-slice silhouette (Blender).
 * Replaced by 6-plane boxcards in `src/lod3-silhouette.js`. Kept for reference.
 */
import { existsSync, mkdirSync, statSync } from 'node:fs';
import { dirname, join } from 'node:path';
import { NodeIO } from '@gltf-transform/core';
import { resolveBlender, ROOT } from '../../src/convert.js';
import { spawnAsync } from '../../src/spawn-async.js';
...
export async function bakeLod3Silhouette(options) {
  ...
  const script = join(ROOT, 'legacy', 'lod3-silhouette', 'blender_lod3_silhouette.py');
  console.log(
