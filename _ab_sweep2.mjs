...
const configs = [
  ['LOD2 noProtect e=0.03 p=0.015', 0.1, 0.03, 0.015, false],
  ['LOD2 noProtect e=0.05 p=0.015', 0.1, 0.05, 0.015, false],
  ['LOD2 noProtect e=0.08 p=0.02 ', 0.1, 0.08, 0.02, false],
];
for (const [label, ratio, error, pruneError, protectUv] of configs) {
